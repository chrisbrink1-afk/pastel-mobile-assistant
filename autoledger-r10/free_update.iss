...
OutputDir=output
OutputBaseFilename=AUTOLEDGER_Free_v2.2.5_R10_UPDATE_from_OLDER_TEST_Setup
Compression=lzma2
...
begin
  ...
  begin
    if not WizardSilent then
      MsgBox('This is the AUTOLEDGER Free R10 UPDATE package, but an existing supported AUTOLEDGER Free installation was not found.' + #13#10 + #13#10 +
