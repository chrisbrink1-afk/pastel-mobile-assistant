[Setup]
; R9 FULL / Stand-alone package: clean-install capable. Same product identity and data path as R6/R8.
...
OutputDir=output
OutputBaseFilename=AUTOLEDGER_Free_v2.2.5_R9_FULL_STANDALONE_TEST_Setup
Compression=lzma2
