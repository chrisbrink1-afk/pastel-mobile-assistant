...
OutputDir=output
OutputBaseFilename=AUTOLEDGER_Pro_v2.2.5_R10_4_UPDATE_from_OLDER_TEST_Setup
Compression=lzma2
...
begin
  ...
  begin
    if not WizardSilent then
      MsgBox('This is the AUTOLEDGER Pro R10.4 UPDATE package, but an existing supported AUTOLEDGER Pro installation was not found.' + #13#10 + #13#10 +
