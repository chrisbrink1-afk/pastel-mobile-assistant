[Setup]
; R8 FULL package: clean-install capable. Same permanent Pro product identity/entitlement lineage.
...
OutputDir=output
OutputBaseFilename=AUTOLEDGER_Pro_v2.2.5_R8_FULL_TEST_Setup
Compression=lzma2
